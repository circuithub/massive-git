...
exports.testCreatePlainTree = ->
  blob1 = new Blob("test-content", "circuithub.com/anton/project1")
  blob2 = new Blob("1111", "circuithub.com/anton/project1")
  tree = new Tree([blob1, blob2], "circuithub.com/anton/project1")
...
exports.testCreateHierarchicalTree = ->
  blob1 = new Blob("test-content", "circuithub.com/anton/project1")
  blob2 = new Blob("1111", "circuithub.com/anton/project1")
  subtree = new Tree([blob2], "circuithub.com/anton/project1")
  assert.equal "e5703eef623188c5540d9ac3f203e069ed1382af", subtree.id()
  assert.equal 1, subtree.entries.length
  tree = new Tree([blob1, subtree], "circuithub.com/anton/project1")
